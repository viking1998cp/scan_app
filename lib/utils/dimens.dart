...
class DimensCommon {
  ...
  static double kPaddingToolbar = 16;
  static double kPaddingMax = 20;
  static double kPaddingMenu = 30;
  static double kPaddingMedium = 14;
  static double kPaddingMin = 12;
  static double kPaddingVeryMin = 8;
